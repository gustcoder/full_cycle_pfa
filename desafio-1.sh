...
echo "Subindo nginx..."
docker run --rm -d -it --name nginx -p 8080:80 --network fullcycle_desafio1 gustcoder/nginx
...
docker run --rm -it --name php8 -p 8090:8090 --network fullcycle_desafio1 gustcoder/php8
